...
RegisterNetEvent('tmg-log:server:CreateLog', function(name, title, color, message, tagEveryone, imageUrl)
        ...
        local embedData = {
            {
                ...
                ['author'] = {
                    ['name'] = 'TMGCore Logs',
                    ['icon_url'] = 'https://raw.githubusercontent.com/GhzGarage/tmg-media-kit/main/Display%20Pictures/Logo%20-%20Display%20Picture%20-%20Stylized%20-%20Red.png',
                },
...
TMGCore.Commands.Add('testwebhook', 'Test Your Discord Webhook For Logs (God Only)', {}, false, function()
    TriggerEvent('tmg-log:server:CreateLog', 'testwebhook', 'Test Webhook', 'default', 'Webhook setup successfully')
end, 'god')
